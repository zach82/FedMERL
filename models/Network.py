...
class distill_qnet(nn.Module):
    def __init__(self, state_dim, action_dim):
        ...
        self.feature_q1 = nn.Sequential(
            OrderedDict([ ('q1_l1', nn.Linear(state_dim + action_dim, 256)),
                         ('relu1', nn.ReLU()), ('q1_l2', nn.Linear(256, 256)),
                        # ('attention', SelfAttentionLayer(128, 128)),
                         ('relu2', nn.ReLU())])
        )
        # self.feature_q1 = nn.Sequential(
        ...
        self.feature_q2 = nn.Sequential(
            OrderedDict([ ('q2_l1', nn.Linear(state_dim + action_dim, 256)),
                         ('relu1', nn.ReLU()), ('q2_l2', nn.Linear(256, 256)),
                          # ('attention', SelfAttentionLayer(128, 128)),
                         ('relu2', nn.ReLU())])
        )
        # self.feature_q2 = nn.Sequential(
